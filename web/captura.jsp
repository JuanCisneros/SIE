                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="http://192.168.1.213:8080/Ubi" target="_blank" >Ubicaciones</a></li>
                                    <li class="divider"></li>
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control" name="list_provee" onKeyPress="return tabular(event, this)" id="list_provee" onchange="proveedor();">
                                        ...
                                        <%
                                            try {
                                                con.conectar();
                                                ResultSet rset = con.consulta("select F_NomPrv from provee_all");
                                                while (rset.next()) {
                                                    out.println("<option value = '" + rset.getString("F_NomPrv") + "'>" + rset.getString("F_NomPrv") + "</option>");
                                                }
                                                con.cierraConexion();
                                            } catch (Exception e) {
                                            }
...
<script>
    ...
    <%
        try {
            ...
            ResultSet rset = con.consulta("select F_NomPrv from provee_all");
            while (rset.next()) {
                out.println("\'" + rset.getString("F_NomPrv") + "\',");
            }
            con.cierraConexion();
        } catch (Exception e) {
        }
