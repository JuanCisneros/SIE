                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="http://192.168.1.213:8080/Ubi">Ubicaciones</a></li>
                                    <li class="divider"></li>
                    ...
                    <form class="form-horizontal" role="form" name="formulario1" id="formulario1" method="post" action="Proveedores">
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <div class="col-lg-1"><a class="btn btn-block btn-success" onclick="window.location='catalogo.jsp';">Regresar</a></div>            
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-group">
...
<script language="javascript">
    ...
    function tabular(e, obj)
    {
      ...
      function valida_alta() {
        ...
        var Telefono = document.formulario1.Telefono.value;
        if (Nombre === "") {
            alert("El campo nombre no puede ir vacío, verifique.");
            return false;
        } 
        else if(Telefono ===""){
             alert("El campo teléfono no puede ir vacío, verifique.");
            return false;
